#include "VulkanOffscreenPipeline.h"
#include <fstream>
#include <iostream>
#include "../VulkanUtils.h"

VkShaderModule VulkanOffscreenPipeline::CreateShaderModule(VkDevice device, const std::vector<char>& code) {
...
void VulkanOffscreenPipeline::Create(VkDevice device, VkExtent2D extent, VkRenderPass offscreenRenderPass) {
...
void VulkanOffscreenPipeline::Destroy(VkDevice device) {
