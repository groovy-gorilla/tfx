...
layout(constant_id = 0) const float screenWidth = 320;
layout(constant_id = 1) const float screenHeight = 200;
layout(constant_id = 2) const float reverseScreenWidth = 1.0/320.0;
layout(constant_id = 3) const float reverseScreenHeight = 1.0/200.0;
